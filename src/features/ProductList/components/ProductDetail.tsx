...
// review functions
  ...
  const totalRatingGiven = totalOnestar + totalTwostar + totalThreestar + totalFourstar + totalFivestar;
  const calculateRating = productReview ? (totalRatingGiven / productReview.length).toFixed(1) : 0;
  ...
  useEffect(() => {
    dispatch(getaProductReviews(id)).then((res: any) => {
      ...
      if(res && res.payload !== undefined){
        if(totalOnestar >= 0 && totalTwostar >=0 && totalThreestar >=0 && totalFourstar >=0 && totalFivestar >=0){
          const data = {
            productId: id,
      ...
      <div className="pt-6">
        ...
        {/* Image gallery */}
          ...
          <div className="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">      
           { product && product.images && product.images.set && product.images.set[0] &&
            <img  
              alt='product image'                
              src={product && product.images && product.images.set && product.images.set[0].url}
          ...
          <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
           ...
           { product && product.images && product.images.set && product.images.set[1] &&
           <img  
           alt='product image'                
           src={product && product.images && product.images.set && product.images.set[1].url}
           className="h-full w-full object-contain lg:h-full lg:w-full"
           style={{ zIndex: 30 }}
            />
            ...
            {/* 3rd img div */}
            <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            { product && product.images && product.images.set && product.images.set[2] &&
            <img  
            alt='product image'                
            src={product && product.images && product.images.set && product.images.set[2].url}
            className="h-full w-full object-contain lg:h-full lg:w-full"
            style={{ zIndex: 30 }}
            />
            }
                  ...
                  <div className="flex flex-col sm:flex-row items-center max-lg:justify-center w-full h-full">
                    <div className="sm:pr-3 sm:border-r border-gray-200 flex items-center justify-center flex-col">
                      ...
                      <div className="flex items-center gap-3 mb-4"> 
                        <StarIcon width={28} height={28} color={ parseInt(theProductRating ? theProductRating : '0') >= 1  ? "orange" : "gray"} fill={ parseInt(theProductRating ? theProductRating : '0') >= 1  ? "orange" : "gray"} />
                        <StarIcon width={28} height={28} color={ parseInt(theProductRating ? theProductRating : '0') >= 2  ? "orange" : "gray"} fill={ parseInt(theProductRating ? theProductRating : '0') >= 2  ? "orange" : "gray"} />
                        <StarIcon width={28} height={28} color={ parseInt(theProductRating ? theProductRating : '0') >= 3  ? "orange" : "gray"} fill={ parseInt(theProductRating ? theProductRating : '0') >= 3  ? "orange" : "gray"} />
                        <StarIcon width={28} height={28} color={ parseInt(theProductRating ? theProductRating : '0') >= 4  ? "orange" : "gray"} fill={ parseInt(theProductRating ? theProductRating : '0') >= 4  ? "orange" : "gray"} />
                        <StarIcon width={28} height={28} color={ parseInt(theProductRating ? theProductRating : '0') >= 5  ? "orange" : "gray"} fill={ parseInt(theProductRating ? theProductRating : '0') >= 5  ? "orange" : "gray"} />
                      </div>
                  ...
                  <footer className="flex justify-between items-center mb-2">
                      ...
                      <div className="flex text-sm text-gray-600 dark:text-gray-400">
                        <div>
                          <StarIcon
                            ...
                            height={15}
                            color={
                              review && review.rating >= 1 ? "orange" : "gray"
                            }
                            fill={
                              review && review.rating >= 1 ? "orange" : "gray"
                            }
                        ...
                        <div>
                          <StarIcon
                            ...
                            height={15}
                            color={
                              review && review.rating >= 2 ? "orange" : "gray"
                            }
                            fill={
                              review && review.rating >= 2 ? "orange" : "gray"
                            }
                        ...
                        <div>
                          <StarIcon
                            ...
                            height={15}
                            color={
                              review && review.rating >= 3 ? "orange" : "gray"
                            }
                            fill={
                              review && review.rating >= 3 ? "orange" : "gray"
                            }
                        ...
                        <div>
                          <StarIcon
                            width={15}
                            color={
                              review && review.rating >= 4 ? "orange" : "gray"
                            }
                            fill={
                              review && review.rating >= 4 ? "orange" : "gray"
                            }
                        ...
                        <div>
                          <StarIcon
                            ...
                            height={15}
                            color={
                              review && review.rating >= 5 ? "orange" : "gray"
                            }
                            fill={
                              review && review.rating >= 5 ? "orange" : "gray"
                            }
                    ...
                    >
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        <time>
                          {format(review && review.createdAt, "MMM. d, yyyy")}
                        </time>
                      </p>
