          ...
          >
            ...
            {Array.from({
              ...
              <div
                ...
                className={
                  index + 1 === page
                    ? "z-10 bg-indigo-600 cursor-pointer px-2 py-2 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
