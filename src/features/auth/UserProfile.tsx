              ...
              >
                ...
                <div className="grid grid-cols-1 gap-x-3 gap-y-4 lg:grid-cols-4">
                  ...
                  { !Object.keys(user).length ? (
                    <div className="lg:col-span-3 bg-white h-1/2 rounded-lg pt-10">No Profile Info Available pls update profile</div>
                  ) : (
                              ...
                              <div className="text-center my-4">
                                ...
                                <div className="py-2">
                                  ...
                                  <div className="inline-flex text-gray-700 dark:text-gray-300 items-center">
                                    ...
                                    {user && user.country && user.country.toUpperCase()}
                                  </div>
                                </div>
                              </div>
                                ...
                                <div className="profile info">
                                  ...
                                  <div className="flex items-center my-1">
                                    <div className="flex ml-6 gap-6 truncate text-lg font-poppins text-center">
                                      ...
                                      Joined {format(user.createdAt, 'yyyy/ dd/ MM')}
                                    </div>
                                  </div>
                                </div>
                              )}
